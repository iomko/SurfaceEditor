	...
	void onImGuiRender() override {
		...
		if (ImGui::TreeNode("BrushTool")) {
			if (ImGui::Button("Choose Brush Tool")) {
				...
				ViewPortsHolderContext::m_viewPortsHolder->m_currentTool = ToolRegistry::getTool<BrushTool>();
				...
				ViewPortsHolderContext::m_viewPortsHolder->m_currentToolParams = brushToolParams;
			}
